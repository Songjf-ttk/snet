<template>
  ...
  <p>旧密码：<input type="password" v-model="new_password"></p>
  <h3>请输入新密码&#8195&#8195&#8195&#8195&#8195&#8195&#8195&#8195</h3>
  <p>新密码：<input type="password" v-model="new_password"></p>
  ...
  methods: {
    ...
    submit() {
      var returnData = {
        ...
        newpassword1:this.new_password,
      ...
      axios
        .post("http://120.78.196.67:8000/rest-password",JSON.stringify(returnData))
        .then ( (res) =>{
          alert(res.data.info);
